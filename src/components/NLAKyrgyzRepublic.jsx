...
export default function NLAKyrgyzRepublic() {
  ...
  const documentList = [
    ...
    {
      "text": "Кыргыз Республикасынын 2024-жылдын 10-майындагы No 231 токтому. Башталгыч, орто жана жогорку кесиптик билим берүүнүн мамлекеттик билим берүү уюмдарын каржылоонун тартиби жөнүндө.",
