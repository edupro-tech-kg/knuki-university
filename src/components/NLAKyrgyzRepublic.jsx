...
export default function NLAKyrgyzRepublic() {
  ...
  const links = t("documentNLA.links", { returnObjects: true, defaultValue: [] });
    ...
    <section className="container mx-auto px-4 sm:px-6 lg:px-20 py-3">
          ...
          >
            ...
            <div className="flex justify-end">
              <Button
                ...
                onClick={() =>
                  window.open(
                    links[index] || `https://legal.gov.kg/doc${index + 1}`,
                    "_blank"
                  )
                }
      ...
      <div className="hidden md:block overflow-x-auto">
        <table className="min-w-full border border-black">
          <tbody>
            {documents.map((text, index) => (
              <tr key={index} className="border-b border-black last:border-b-0 hover:bg-gray-50 transition-colors">
