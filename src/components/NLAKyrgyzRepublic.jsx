...
export default function NLAKyrgyzRepublic() {
  ...
  const STATIC_ITEMS = [
    ...
    {
      text: "Кыргыз Республикасында 2021-2025-жылдары мамлекеттик тилди өнүктүрүү жана тил саясатын өркүндөтүү программасы (КР Министрлер Кабинетинин 2022-жылдын 7-февралындагы № 67, 2023-жылдын 10-февралындагы № 64 токтомдорунун",
