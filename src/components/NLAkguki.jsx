...
const nlaKgukiDocuments = [
      {
        text: "Кыргыз ССР Министрлер Советинин 1967-жылдын 30-августундагы № 482 «Кыргыз мамлекеттик искусство институтун уюштуруу жөнүндө» токтому (КСИА).",
        id: "doc1",
      },
      {
        text: "Кыргыз ССР Министрлер Советинин 1974-жылдын 28-январындагы № 21 КСИИни «Бүбүсара Бейшеналиева атындагы Кыргыз мамлекеттик искусство институту» деп расмий аталышы жөнүндө токтому",
        id: "doc2",
      },
      {
        text: "Б.Бейшеналиева атындагы Кыргыз мамлекеттик искусство институтун Бүбүсара Бейшеналиева атындагы Кыргыз мамлекеттик маданият жана искусство университетине өзгөртүү жөнүндө Кыргыз Республикасынын Өкмөтүнүн 2013-жылдын 28-августундагы № 470 токтому",
        id: "doc3",
      },
      {
      ...
      {
        text: "КЫРГЫЗ РЕСПУБЛИКАСЫНЫН ЖОГОРКУ КЕСИПТИК БИЛИМ БЕРҮҮНҮН МАМЛЕКЕТТИК БИЛИМ БЕРҮҮ СТАНДАРТЫ. Квалификация: \"магистр\" (2024-жылдын 21-сентябрындагый №1815/1 буйругу менен бекитилген.) 570200 Музыкалык искусство 570300 Театралдык искусство 550600 Көркөмдүк билим берүۈ",
        id: "doc17",
      },
      {
        text: "Б.Бейшеналиева атындагы Кыргыз улуттук маданият жана искусство университетинин негизги билим берүү программасы (БПП) жөнүндө жобосу",
        id: "doc18",
      },
      {
      ...
      {
        text: "Орто жана жогорку кесиптик билим жөнүндө мамлекеттик документтер жана аларды даярдоо, төлөө, сактоо, берүү жана эсепке алуунун тартиби жөнүндө жобо. Кыргыз Республикасынын Билим берүү жана илим министрлигинин 2025-жылдын 10-мартындагы № 249/1 буйругунун тиркемеси.",
        id: "doc20",
      },
      {
        text: "Б.Бейшеналиева атындагы КУМИУнун ишеним кутусу жөнүндө жобо",
        id: "doc21",
      },
      {
        text: "КР Министрлер Кабинетинин 2024-жылдын 27-сентябрындагы № 590 Жогорку кесиптик билим берүүнүн билим берүү уюмдарынын ишин жөнгө салган ченемдик укуктук актыларды бекитүү жөнүндө токтому. https://cbd.minjust.gov.kg/7-33050/edition/17445/kg",
        id: "doc22",
      }, {
        text: "Окуу-методикалык комплекс жөнүндө жобо",
        id: "doc23",
      }, {
        text: "Академиялык мобилдүүлүк жөнүндө жобо",
        id: "doc24"
      },
      {
      ...
      {
        text: "Б.Бейшеналиева атындагы КНУКИде билим берүүнүн сапатына керектөөчүлөрдүн канааттануусуна мониторинг жүргүзүү жөнүндө жобо",
        id: "doc26"
      },
      {
        text: "КР Министрлер Кабинетинин 2024-жылдын 27-сентябрындагы № 590 Жогорку кесиптик билим берүүнүн билим берүү уюмдарынын ишин жөнгө салган ченемдик укуктук актыларды бекитүү жөнүндө токтому. https://cbd.minjust.gov.kg/7-33050/edition/17445/kg",
      ...
      {
        text: "Б.Бейшеналиева атындагағы Кыргыгыз улуттук маданият жана искусство университетинде\nун эмгекти коргоо жана билим берүү процессссинде коопсуз шарттарды камсыз кылуу\ntууралуу ЖОБО",
        id: "doc31"
      },
      {
