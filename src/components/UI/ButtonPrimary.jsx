...
const ButtonPrimary = ({
  ...
  const getSizeClasses = () => {
    switch (size) {
      ...
      case 'auto': return 'py-3 px-6 w-full sm:w-auto';
      default: return 'py-3 px-6'; // md
    }
  };
  ...
  const defaultClasses = 'border-black text-black bg-transparent hover:bg-black hover:text-white active:bg-gray-800 active:text-white';
